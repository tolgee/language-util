...
describe("flags", () => {
    ...
    test('returns flags for available locales', () => {
        const result = availableLocales.availableLocales.modern.reduce((acc, curr) => (
            {...acc, [curr]: getLanguageRegions(curr).map(r => getCountryFlagEmoji(r))}
        ), {}) as { [key: string]: any }
    ...
    test('returns correct symbol to hex', () => {
        ...
        expect(symbolToHex("🏴󠁧󠁢󠁥󠁮󠁧󠁿󠁧󠁢󠁥󠁮󠁧󠁿")).toEqual("1f3f4-e0067-e0062-e0065-e006e-e0067-e007f-e0067-e0062-e0065-e006e-e0067-e007f")
